...
function makeAutoStartLinuxDesktop(): AutoStart {
    ...
    const file = join(dir, "nunbop.desktop");
    ...
    return {
        ...
        enable() {
            const desktopFile = stripIndent`
                ...
                Type=Application
                Name=Nunbop
                Comment=Nunbop autostart script
...
// The portal call uses the app id by default, which is org.chromium.Chromium, even in packaged Nunbop.
// This leads to an autostart entry named "Chromium" instead of "Nunbop".
