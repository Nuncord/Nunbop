...
const nunbopDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(nunbopDir, "Uninstall Nunbop.exe"));

export const DATA_DIR =
    process.env.NUNCORD_USER_DATA_DIR || (PORTABLE ? join(nunbopDir, "Data") : join(app.getPath("userData")));
