...
import { useState } from "@nuncord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Nunbop on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Nunbop minimized when starting with system"}
