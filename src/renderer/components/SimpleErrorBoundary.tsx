...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@nuncord/types/components";
import { FluxDispatcher, InviteActions } from "@nuncord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Nuncord and Nunbop are fully up to date. You can get help in our{" "}
